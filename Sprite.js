...
Sprite.prototype.varredura = function(map) {
	var gx = Math.floor(this.x/map.SIZE);
	var gy = Math.floor(this.y/map.SIZE);
	this.tesouros = 0;
	this.minas = 0;
	if(map.cells[gy-1][gx-1] == 3) {
		this.tesouros++;
	}
	else if(map.cells[gy-1][gx-1] == 4) {
		this.minas++;
	}
	if(map.cells[gy-1][gx] == 3) {
		this.tesouros++;
	}
	else if(map.cells[gy-1][gx] == 4) {
		this.minas++;
	}
	if(map.cells[gy-1][gx+1] == 3) {
		this.tesouros++;
	...
	if(map.cells[gy][gx-1] == 3) {
		this.tesouros++;
	}
	else if(map.cells[gy][gx-1] == 4) {
		this.minas++;
	}
	if(map.cells[gy][gx+1] == 3) {
		this.tesouros++;
